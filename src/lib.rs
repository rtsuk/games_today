...
pub const FIVE_LETTER_LAST_NAMES: &[&str] = &[
    "Aberg", "Acomb", "Acton", "Adams", "Agnew", "Ahcan", "Ahern", "Ahola", "Allan", "Allen",
    "Alley", "Allum", "Alves", "Armia", "Asham", "Ashby", "Aubin", "Aubry", "Audet", "Auger",
    "Aulie", "Aulin", "Aurie", "Avery", "Awrey", "Ayres", "Babin", "Baird", "Baker", "Balej",
    "Balon", "Banks", "Barbe", "Barch", "Baron", "Barry", "Bates", "Bathe", "Bauer", "Bayda",
    "Beech", "Beers", "Begin", "Bekar", "Belak", "Belle", "Belov", "Benda", "Berra", "Berry",
    "Betts", "Bicek", "Biega", "Bierk", "Biggs", "Biron", "Bjork", "Black", "Blair", "Blais",
    "Blake", "Blidh", "Block", "Bloom", "Bodak", "Boddy", "Bodie", "Boehm", "Boldy", "Bonar",
    "Bonin", "Bonni", "Boone", "Booth", "Borer", "Bossy", "Bouck", "Bouma", "Bowen", "Bower",
    "Bowey", "Boyce", "Boyer", "Boyes", "Boyko", "Boyle", "Bozak", "Bozek", "Bozon", "Brady",
    "Bratt", "Braun", "Breen", "Brent", "Britz", "Broda", "Broll", "Brome", "Brown", "Bruce",
    "Brule", "Bubla", "Bucyk", "Budaj", "Bulis", "Burch", "Burke", "Burns", "Burry", "Buzek",
    "Byers", "Bykov", "Byram", "Byron", "Cahan", "Carey", "Carle", "Carlo", "Caron", "Carse",
    "Casey", "Cates", "Chara", "Chase", "Check", "Ciger", "Clark", "Cline", "Clowe", "Clune",
    "Cooke", "Corsi", "Corso", "Corvo", "Cotch", "Coutu", "Cowan", "Cowen", "Cowie", "Coyle",
    "Crabb", "Craig", "Crisp", "Cross", "Crowe", "Curry", "Cutta", "Dafoe", "Daley", "Dalpe",
    "Danis", "Darby", "Davie", "Davis", "Dawes", "DeLeo", "Debol", "Denis", "Dewar", "Dietz",
    "Divis", "Djoos", "Doran", "Dorey", "Doull", "Drake", "Dries", "Druce", "Drury", "Duehr",
    "Dumba", "Dupre", "Duris", "Durzi", "Dwyer", "Eager", "Eakin", "Eaton", "Eaves", "Edler",
    "Egers", "Ehman", "Ekman", "Elias", "Eliot", "Eller", "Ellis", "Elomo", "Elson", "Emery",
    "Ennis", "Errey", "Esche", "Evans", "Fahey", "Faksa", "Fasth", "Faulk", "Fauss", "Faust",
    "Fayne", "Fedun", "Fedyk", "Felix", "Fiala", "Field", "Fiset", "Flett", "Flinn", "Flood",
    "Floyd", "Flynn", "Focht", "Folco", "Foley", "Folin", "Foote", "Forey", "Fotiu", "Freer",
    "Fritz", "Frost", "Fusco", "Gaetz", "Gagne", "Garon", "Gaume", "Gavey", "Gavin", "Geale",
    "Geran", "Gerbe", "Gibbs", "Giles", "Gladu", "Glass", "Gloor", "Glynn", "Godin", "Gomez",
    "Goren", "Gould", "Grant", "Greco", "Green", "Greer", "Gregg", "Greig", "Grier", "Gross",
    "Gruen", "Gruhl", "Gryba", "Gudas", "Guhle", "Guite", "Guren", "Gusev", "Hajdu", "Hajek",
    "Halak", "Haley", "Halko", "Halmo", "Hamel", "Handy", "Hanna", "Hardy", "Hasek", "Hauer",
